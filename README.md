...
| [Исследование успешности игрового рынка](games_success_analysis) | Выявление определяющие успешность игры закономерности: исследовательский анализ данных, составление портрета пользователя, проверка гипотез| *pandas, numpy, matplotlib, seaborn, scipy*| Яндекс Практикум|
