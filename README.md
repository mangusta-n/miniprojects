...
| [Обработка перечетных ведомостей, подсчет объемов](tree_describer) | Скрипт для Google Colab для быстрого подсчета объевом на вырубку и пересадку (вычисление нужных для сметы параметров, учитывая данные деревьев)| *pandas, numpy*| Раочий проект|
